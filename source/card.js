...
function content(datafull, i, id){
    ...
    const bio = contentSection("Биография",id);
    ...
    const prizes = contentSection("Награды",id);
    ...
    const works = contentSection("Труды",id);
    ...
    gallery = contentSection("Галерея", id);
    ...
    sources = contentSection("Источники",id);
...
function contentSection(name,id) {
